...
namespace GroupAddress.UI
{
    public partial class MainForm : Form
    {
        ...
        private bool HandleProjectChanged()
        {
            ...
            var res2 = MessageBox.Show("�nderungen am aktuellen Projekt speichern?", "Projekt ge�ndert", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Warning);
        ...
        private void DeleteMainGroup(string id)
        {
            ...
            if (MessageBox.Show("Haupgruppe l�schen?", "Hauptgruppe l�schen", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
            {
        ...
        private void GroupManagerToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bitte erst eine Hauptgruppe erstellen/ausw�hlen.", "Keine Hauptgruppe", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        private void DeleteCellsToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                var res = MessageBox.Show("Gruppenadressen l�schen?", "Gruppenadressen l�schen", MessageBoxButtons.YesNo, MessageBoxIcon.Warning);
        ...
        private void DeleteroupToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (groupGAs.Count == 0)
            {
                var res = MessageBox.Show("M�chten Sie die Gruppe wirklich l�schen?", "Gruppe l�schen", MessageBoxButtons.OKCancel, MessageBoxIcon.Warning);
